...
<form method="POST" action="../php/order-handler.php">
    ...
    Name on Card <br>
    <input type="text" id="cname" name="cardname"  placeholder="Nimesh D B W N" required> <br>
    Credit card number<br>
    <input type="text" id="ccnum" name="cardnumber" placeholder="1234-1234-1234-1234" required><br>
    Exp Month<br>
    <input type="text" id="expmonth" name="expmonth" placeholder="June" required><br>
    Exp Year<br>
    <input type="text" id="expyear" name="expyear" placeholder="2022" required><br>
    CVV<br>
    <input type="text" id="cvv" name="cvv" placeholder="119" required><br>
